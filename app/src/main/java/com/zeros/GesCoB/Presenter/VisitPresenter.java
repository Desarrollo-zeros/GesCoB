...
public class VisitPresenter extends Visit {
    ...
    public VisitPresenter(String cedula, String cliente, String direccion, String estado_suministro, String departamento, String municipio) {
        super(cedula,cliente,direccion,estado_suministro.toUpperCase(),departamento,municipio);
    }
